...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative z-10">
      ...
      <div className="lg:h-[calc(100vh-64px)] max-w-7xl mx-auto px-5 md:px-7 h-full py-5 pt-16 md:py-10 lg:py-0 lg:pt-0 flex flex-wrap flex-col-reverse md:flex-row items-center justify-center overflow-hidden ">
        <motion.div
          variants={uptoDown}
          initial="initial"
          whileInView="animate"
